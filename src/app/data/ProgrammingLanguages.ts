...
export const django : Languages[] = [
  ...
  export const djangores : Languages[]  = [
    {
      name: "python",
      imgurl:
        "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg",
    ...
    },
    {
      name: "djangorest",
      imgurl:
        "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/djangorest/djangorest-plain-wordmark.svg",
    },
    {
      name: "postman",
      imgurl:
  ...
  export const frontend1 : Languages[] = [
    {
      name: "html",
      imgurl:
  ...
  export const frontend2: Languages[] = [
    {
      name: "reactjs",
      imgurl:
  ...
  export const frontend3: Languages[] = [
    {
      name: "nextjs1",
      imgurl:
  ...
  export const sc: Languages[] = [
    ...
    {
      name:"sele",
      imgurl:"https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/selenium/selenium-original.svg"
    }
    
  ];

  export const mo: Languages[] = [
    {
      name: "reactjs",
      imgurl:
        "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg",
